    ...
    "paths": {
        ...
        "/computeruse/browser/open": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Browser open parameters",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/BrowserOpenRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "BrowserOpenRequest": {
            ...
            "properties": {
                ...
                "remoteDebug": {
                    "description": "Whether to open the 9222 debug port",
                    "type": "boolean"
                },
                "url": {
                    "type": "string"
