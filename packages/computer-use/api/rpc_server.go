...
func (m *ComputerUseRPCServer) OpenBrowser(arg *BrowserOpenRequest, resp *Empty) error {
	_, err := m.Impl.OpenBrowser(arg)
	return err
}

func (m *ComputerUseRPCServer) CloseBrowser(arg any, resp *Empty) error {
	_, err := m.Impl.CloseBrowser()
	return err
}
