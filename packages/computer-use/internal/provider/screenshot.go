...
func (u *ComputerUse) TakeScreenshot(req *api.ScreenshotRequest) (*api.ScreenshotResponse, error) {
...
func (u *ComputerUse) TakeRegionScreenshot(req *api.RegionScreenshotRequest) (*api.ScreenshotResponse, error) {
	// Debug: Check DISPLAY environment variable
	display := os.Getenv("DISPLAY")
