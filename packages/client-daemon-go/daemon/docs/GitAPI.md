...
func main() {
	request := *openapiclient.NewGitDeleteBranchRequest("Name_example", "Path_example") // GitDeleteBranchRequest | Delete branch request
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **request** | [**GitDeleteBranchRequest**](GitDeleteBranchRequest.md) | Delete branch request | 
