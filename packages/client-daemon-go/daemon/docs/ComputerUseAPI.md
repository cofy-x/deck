...
[**CloseBrowser**](ComputerUseAPI.md#CloseBrowser) | **Post** /computeruse/browser/close | Close browser
...
[**OpenBrowser**](ComputerUseAPI.md#OpenBrowser) | **Post** /computeruse/browser/open | Open or navigate browser
...
import (
	...
	"fmt"
	"os"
	openapiclient "github.com/cofy-x/deck/packages/client-daemon-go/daemon"
)
...
> map[string]interface{} CloseBrowser(ctx).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ComputerUseAPI.CloseBrowser(context.Background()).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `ComputerUseAPI.CloseBrowser``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CloseBrowser`: map[string]interface{}
	fmt.Fprintf(os.Stdout, "Response from `ComputerUseAPI.CloseBrowser`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCloseBrowserRequest struct via the builder pattern
...
> map[string]interface{} OpenBrowser(ctx).Request(request).Execute()
...
func main() {
	request := *openapiclient.NewBrowserOpenRequest() // BrowserOpenRequest | Browser open parameters

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ComputerUseAPI.OpenBrowser(context.Background()).Request(request).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `ComputerUseAPI.OpenBrowser``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `OpenBrowser`: map[string]interface{}
	fmt.Fprintf(os.Stdout, "Response from `ComputerUseAPI.OpenBrowser`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiOpenBrowserRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **request** | [**BrowserOpenRequest**](BrowserOpenRequest.md) | Browser open parameters | 
