...
import { validateDescription, validateSkillName } from '../utils/validators.js';
import { ApiError } from '../errors.js';
import { projectSkillsDir } from '../utils/workspace-files.js';
...
export async function listSkills(
  ...
  if (includeGlobal) {
    const globalPilot = join(homedir(), '.config', 'opencode', 'skills');
    const globalClaude = join(homedir(), '.claude', 'skills');
    items.push(...(await listSkillsInDir(globalPilot, 'global')));
